  ...
  var layout = new Layout([View, 'button', {},
    ...
    [Container, 'containerbutton', {},
      ...
      [View, 'button-default', {},
        ...
        [View, 'buttons-floating-secondary', {},
          [Button, 'floating', { text: 'floating secondary', type: 'floating', color: 'secondary' }],
          [Button, 'floating-compact', { text: 'Compact', type: 'floating', style: 'compact', color: 'secondary' }],
          [Button, 'floating-dense', { text: 'Dense', type: 'floating', style: 'dense', color: 'secondary' }],
